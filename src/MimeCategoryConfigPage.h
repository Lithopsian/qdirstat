...

{
    ...
    protected slots:
		...
		/**
		 * done() has been called on the dialog.  Treat this is as if it was
		 * a destructor, although the page may not be destroyed at this stage.
		 **/
//		void finished( int result );
    ...
    protected:
		 ...
		 * Implemented from ListEditor.
		 **/
//		virtual QString deleteConfirmationMessage( void * ) Q_DECL_OVERRIDE { return ""; }
